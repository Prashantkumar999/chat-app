    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
          <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Welcome to Chat App</h1>
              ...
              {messages.map((msg, index) => (
                ...
                >
                  <div>
                    ...
                    <div className={`inline-block px-4 py-2 rounded-lg ${msg.username === username ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-800'}`}>
                      {msg.message}
                    </div>
                    {msg.reaction && (
